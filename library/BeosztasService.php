...
class BeosztasService {
    ...
    public function getBookingPageBeosztasok($day, $helyszinId, $szuresTipusId) {
        ...
        $beoRes = sql_query("SELECT b.*, min(tol) as mintol, max(ig) as maxig, MAX(potig) as maxpotig, o.nev as orvosnev, o.description as orvosdescription, o.pecsetszam, o.description, o.onlytel FROM orvos_beosztas_new b 
