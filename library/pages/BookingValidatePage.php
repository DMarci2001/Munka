        ...
        if (!empty($this->foglalasData)) {
            ...
            if ($transactionData = $simpleService->getTransactionLog($this->id)) {
                ...
                if (in_array($transactionData["result"], ["SUCCESS", "FINISHED"])) {
                    ...
                    echo "{$webText["kedves"]} ".$this->foglalasData["nev"]."!<br>";
                    echo "<br/>A fizetési folyamat sikerült, megrendeléséről egy visszaigazoló emailt küldtünk.<br/>Felhívjuk a figyelmét, hogy abban az esetben  ha panaszait nem tudjuk kezelni Web-Doktor szolgáltatásunkon keresztül, úgy a teljes összeg visszautalásra kerül.<br/><br/>";
