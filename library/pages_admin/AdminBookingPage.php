...
class AdminBookingPage extends AdminCorePage
{
    ...
    {   
        ...
        if ($jogosult) {
            ...
            if (in_array($reservationData["id"], [894123,896306,894553,895755,896202])) {
                $extraInfo .= "<span class='externalmark' style='background-color:#0a0'>FIZETVE!</span> ";
            }
    ...
    private function cimFilter(): string
    {
        ...
        if (Booking_Constants::SQL_DB == "keltexmed") {
            $order = "h.id not in (292, 328, 372, 357), trim(h.cim)";
        }
