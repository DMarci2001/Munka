...
class AdminBookingPage extends AdminCorePage
{
    ...
    public function __construct()
    {
        ...
        if (isset($_POST["searchkey"])) {
            ...
            $results = sql_query("select f.*, c.megnev as cegnev, o.nev as orvosnev, d.id as docid, sz.megnev as szurestipusnev from foglalasok f
                ...
                where {$sqlFilter} and f.helyszinid=:helyszinid {$cegFilter} ".($this->adminUser->onlyDoctorReservations()?" and f.orvosassigned=".intval($this->adminUser->user["orvosid"]):"")."
    ...
    public function showElojegyzesTable($setDay) {
        ...
        $htmlout.="<div style='display:table-cell;vertical-align:middle;padding-left:10px;'>{$cegFilterHTML} {$cegSearchLink}</div>";
