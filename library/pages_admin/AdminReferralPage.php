		...
		if(isset($_POST['saveTest']) || isset($_POST["sendSelectedReferrals"])){
			...
			if (isset($_POST['selected-data']) && is_array($_POST['selected-data']) && count($_POST['selected-data'])>0) {
				...
				foreach ($_POST['selected-data'] as $selector) {
					...
					$mbody.= "<p style='font-family:calibri;font-size:14px'>Az alkalmassági eredményt kérjük <strong>Kovács Éva részére elküldeni</strong> a <a href=\"mailto:kovacs.eva2@opusenergetika.hu\" style=\"color:#a90000\">kovacs.eva2@opusenergetika.hu</a> e-mail címre.</p>";
				...
				if (isset($_POST['saveTest'])) {
					...
					$mail->AddAddress("kovacs.eva2@opusenergetika.hu");
				}
