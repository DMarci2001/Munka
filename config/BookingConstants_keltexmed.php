...
class Booking_Constants {
    ...
    //const FO_API_PASSWORD           = "KMa7PnbLPkl9KRTp"; //régi fehérvári
    //const FO_IFC_NAME               = "KELTEX_MED"; //régi fehérvári
    const FO_API_TEST_PASSWORD      = "KMa7PnbLPkl9KRTp";

    const FO_IFC_NAME               = "KELTEXMED_BICSKEI";
    const FO_API_PASSWORD           = "54LOP65frt7hurSE";
