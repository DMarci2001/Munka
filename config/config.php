...
const DB_PORT = 3306;
const DB_NAME = 'eszkoznyilvantartas';   // éles: a klinikai adatbázis neve
const DB_USER = 'root';
const DB_PASS = '';                       // XAMPP alapértelmezés: üres jelszó
...
const SSO_SECRET      = 'CHANGE_THIS_TO_A_LONG_RANDOM_STRING';
