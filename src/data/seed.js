...
// ---- Eszközök -----------------------------------------------
// status: Deployed | Pending return | Ready to deploy | Reserved |
...
export const devices = [
  {
    ...
    status: 'Deployed', condition: 'Jó', notes: '',
  ...
  },
  {
    ...
    status: 'Ready to deploy', condition: 'Jó', notes: '',
  ...
  },
  {
    ...
    status: 'Reserved', condition: 'Jó', notes: 'Kardiológiai kihelyezésre tervezve.',
  ...
  },
  {
    ...
    status: 'Pending return', condition: 'Jó', notes: '',
    attrs: { os: 'Windows 11', cpu: 'Intel i5-1335U', ram_gb: 16, encrypted: true, domain_joined: true },
  ...
  },
  {
    ...
    status: 'In repair', condition: 'Hibás', notes: 'Túlmelegedés, szerviz alatt.',
  ...
  },
  {
    ...
    status: 'Reserved', condition: 'Jó', notes: '',
  ...
  },
  {
    ...
    status: 'Retired', condition: 'Selejt', notes: 'Selejtezve: nem javítható tápegység-hiba.',
  ...
  },
  {
    ...
    status: 'Lost', condition: 'Ismeretlen', notes: 'Elveszett bejelentés 2026-05-20.',
  ...
  },
  {
    ...
    status: 'Ready to deploy', condition: 'Jó', notes: 'Hordozható, mobil rendelésekhez.',
