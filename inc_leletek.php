<?php
if(isset($_REQUEST['page']) && $_REQUEST['page'] == "leletek"){
echo displayFejlec("Leletek");
echo "<div>Itt találja a leleteit.<br/>Kattintson a dokumentumra a nyomtatáshoz, vagy megtekintéshez.</div><br/>";
...
$request_leletek = sql_query( "SELECT * FROM paciens_leletek pl
	...
	if (sql_num_rows($request_leletek) > 0 || sql_num_rows($request_zaro) > 0) {
		...
		?>
		<span>Nincs még lelet kiállítva.</span>
		<?php
	}
	?>
	<div class = "target-lelet" style = "color:#000" >
	</div>
