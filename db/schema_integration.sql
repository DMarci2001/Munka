...
--   users      (id, username, nev, jogosultsag [0=user,1=storekeeper,2=superadmin])
--   helyszinek (id, cim)
--
-- ELŐFELTÉTEL: users.id és helyszinek.id INT PRIMARY KEY, InnoDB.
-- Ha a klinikai PK-k típusa eltér (pl. INT UNSIGNED / BIGINT), igazítsd
-- az alábbi *_id oszlopok típusát PONTOSAN ugyanarra, különben az FK
-- létrehozása hibára fut.
--
-- BEJELENTKEZÉS: ez a szkript nem ad hozzá jelszó-oszlopot a users táblához.
