...
class AdminScreeningsPage extends AdminCorePage
{
    ...
    public function __construct()
    {
        ...
        if (isset($_POST["addcsomagkapcs"]) && isset($_GET["csszerk"])) {
            sql_query("insert into szurescsomagok_kapcs set csomagid=?", array($_GET["csszerk"]));
        }
        ...
        if (isset($_POST["addtipmegj"]) && isset($_GET["csszerk"])) {
            sql_query("insert into szurestipusok_megj set tipusid=?, csomag=1", array($_GET["csszerk"]));
        }
        ...
        if (isset($_POST["addprice"]) && isset($_GET["csszerk"])) {
            sql_query("insert into arak set tipusid=?, csomag=1", array($_GET["csszerk"]));
        }
